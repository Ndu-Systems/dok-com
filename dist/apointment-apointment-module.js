...
/***/ "./src/app/views/apointment/add-appointment/add-appointment.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/views/apointment/add-appointment/add-appointment.component.ts ***!
  \*******************************************************************************/
...
var AddAppointmentComponent = /** @class */ (function () {
    ...
    AddAppointmentComponent.prototype.showSuccess = function () {
        this.msgs = [];
    ...
    AddAppointmentComponent.prototype.add = function () {
        var _this = this;
        var _objStartDate = JSON.parse(JSON.stringify(this.StartDate));
        var date = _objStartDate.year + '-' + _objStartDate.month + '-' + _objStartDate.day;
        var _objfromTime = JSON.parse(JSON.stringify(this.fromTime));
        var _objtoTime = JSON.parse(JSON.stringify(this.toTime));
        var data = {
        ...
        this.appointmentService.addAppointment(data)
            ...
            if (response == 1) {
                _this.showSuccess();
                setTimeout(function () {
                    _this.router.navigate(['/patients/view', _this.patientId]);
                }, 2000);
            }
            else
                alert(response);
...
/***/ "./src/app/views/apointment/add-appointment/index.ts":
/*!***********************************************************!*\
  !*** ./src/app/views/apointment/add-appointment/index.ts ***!
  \***********************************************************/
/*! exports provided: AddAppointmentComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _add_appointment_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-appointment.component */ "./src/app/views/apointment/add-appointment/add-appointment.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AddAppointmentComponent", function() { return _add_appointment_component__WEBPACK_IMPORTED_MODULE_0__["AddAppointmentComponent"]; });
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _add_appointment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-appointment */ "./src/app/views/apointment/add-appointment/index.ts");
/* harmony import */ var _edit_appointment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit-appointment */ "./src/app/views/apointment/edit-appointment/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'add/:id', component: _add_appointment__WEBPACK_IMPORTED_MODULE_3__["AddAppointmentComponent"]
    },
    {
        path: 'edit/:id', component: _edit_appointment__WEBPACK_IMPORTED_MODULE_4__["EditAppointmentComponent"]
    }
];
...
/* harmony import */ var _edit_appointment__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./edit-appointment */ "./src/app/views/apointment/edit-appointment/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ApointmentModule = /** @class */ (function () {
    ...
    ApointmentModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_apointments_apointments_component__WEBPACK_IMPORTED_MODULE_3__["ApointmentsComponent"], _add_appointment__WEBPACK_IMPORTED_MODULE_11__["AddAppointmentComponent"], _edit_appointment__WEBPACK_IMPORTED_MODULE_12__["EditAppointmentComponent"]],
...
var ApointmentsComponent = /** @class */ (function () {
    function ApointmentsComponent(selectService, router) {
    ...
    ApointmentsComponent.prototype.edit = function (appointment) {
...
/***/ "./src/app/views/apointment/edit-appointment/edit-appointment.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/views/apointment/edit-appointment/edit-appointment.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
module.exports = "<div [@routerTransition]>\r\n  <app-page-header [heading]=\"'Edit Appointment'\" [icon]=\"'fa-edit'\"></app-page-header>\r\n  <p-growl [(value)]=\"msgs\"></p-growl>\r\n  <div class=\"row\">\r\n    <div class=\"col col-xl-12 col-lg-12 col-md-12 col-sm-12\">\r\n      <div class=\"card h-1000 mb-3\">\r\n        <div class=\"card-header\">\r\n        </div>\r\n        <div class=\"card-body table-responsive\">\r\n          <div class=\"col-lg-10 offset-1\">\r\n            <form role=\"form\" *ngIf=\"appointment$ | async as appointment\">\r\n\r\n              <fieldset class=\"form-group\">\r\n                <div class=\"row\">\r\n                  <label class=\"col-md-2\">Description: </label>\r\n                  <div class=\"input-group mb-3 col-md-6 \">\r\n                    <div class=\"input-group-prepend\">\r\n                      <span class=\"input-group-text\" id=\"basic-addon1\">\r\n                        <li class=\"fa fa-edit\"></li>\r\n                      </span>\r\n                    </div>\r\n                    <textarea type=\"text\" [(ngModel)]=\"appointment[0].Description\" [ngModelOptions]=\"{standalone: true}\" class=\"form-control\" placeholder=\"Enter Description\"\r\n                      aria-label=\"FirstName\" aria-describedby=\"basic-addon1\"></textarea>\r\n                  </div>\r\n                </div>\r\n              </fieldset>\r\n              <fieldset class=\"form-group\">\r\n                <div class=\"row\">\r\n                  <label class=\"col-md-2\">Appointment Date: </label>\r\n                  <div class=\"input-group mb-3 col-md-6\">\r\n                    <div class=\"input-group datepicker-input\">\r\n                      <input class=\"form-control\" placeholder=\"yyyy-mm-dd\" name=\"dp\" [(ngModel)]=\"appointment[0].StartDate\" ngbDatepicker #c=\"ngbDatepicker\">\r\n                      <button class=\"input-group-addon\" (click)=\"c.toggle()\" type=\"button\">\r\n                        <!-- <img src=\"img/calendar-icon.svg\" style=\"width: 1.2rem; height: 1rem; cursor: pointer;\"/> -->\r\n                        <span class=\"fa fa-calendar\"></span>\r\n                      </button>\r\n                    </div>\r\n                  </div>\r\n                </div>\r\n              </fieldset>\r\n              <fieldset class=\"form-group\">\r\n                <div class=\"row\">\r\n                  <label class=\"col-md-2\">From Time: </label>\r\n                  <div class=\"mb-3 col-md-4\">\r\n                    <ngb-timepicker [(ngModel)]=\"appointment[0].FromTime\" [ngModelOptions]=\"{standalone: true}\"></ngb-timepicker>                     \r\n                  </div>\r\n                </div>                 \r\n              </fieldset>\r\n              <fieldset class=\"form-group\">\r\n                <div class=\"row\">\r\n                  <label class=\"col-md-2\">To Time: </label>\r\n                  <div class=\"mb-3 col-md-4\">\r\n                    <ngb-timepicker [(ngModel)]=\"appointment[0].ToTime\" [ngModelOptions]=\"{standalone: true}\"></ngb-timepicker>\r\n                  </div>                 \r\n                </div>\r\n              </fieldset>\r\n\r\n              <div class=\"justify-content-center\">\r\n                <a class=\"btn rounded-btn\" (click)=\"save(appointment[0])\">Update Appointment</a> &nbsp;\r\n                <a class=\"btn rounded-btn\" [routerLink]=\"['/appointments']\">Abort</a>\r\n              </div>\r\n            </form>\r\n\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n\r\n  </div>\r\n</div>"

/***/ }),

/***/ "./src/app/views/apointment/edit-appointment/edit-appointment.component.scss":
/*!***********************************************************************************!*\
  !*** ./src/app/views/apointment/edit-appointment/edit-appointment.component.scss ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/apointment/edit-appointment/edit-appointment.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/views/apointment/edit-appointment/edit-appointment.component.ts ***!
  \*********************************************************************************/
...
var EditAppointmentComponent = /** @class */ (function () {
    function EditAppointmentComponent(selectService, route, router, appointmentService) {
        this.selectService = selectService;
        this.route = route;
        this.router = router;
        this.appointmentService = appointmentService;
    ...
    EditAppointmentComponent.prototype.showSuccess = function () {
        this.msgs = [];
        this.msgs.push({ severity: 'success', summary: 'Success Message', detail: 'Appointment Updated Successfully' });
    };
    EditAppointmentComponent.prototype.save = function (appointment) {
        var _this = this;
        ...
        this.appointmentService.editAppointment(data)
            ...
            if (response == 1) {
                _this.showSuccess();
                setTimeout(function () {
                    _this.router.navigate(['/patients/view', appointment.PatientId]);
                }, 2000);
            }
        });
    };
    EditAppointmentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./edit-appointment.component.html */ "./src/app/views/apointment/edit-appointment/edit-appointment.component.html"),
            styles: [__webpack_require__(/*! ./edit-appointment.component.scss */ "./src/app/views/apointment/edit-appointment/edit-appointment.component.scss")],
...
/***/ "./src/app/views/apointment/edit-appointment/index.ts":
/*!************************************************************!*\
  !*** ./src/app/views/apointment/edit-appointment/index.ts ***!
  \************************************************************/
/*! exports provided: EditAppointmentComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _edit_appointment_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit-appointment.component */ "./src/app/views/apointment/edit-appointment/edit-appointment.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EditAppointmentComponent", function() { return _edit_appointment_component__WEBPACK_IMPORTED_MODULE_0__["EditAppointmentComponent"]; });
